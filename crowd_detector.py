    ...
    try:
        ...
        with open(OUTPUT_CSV_PATH, 'w', newline='') as csv_file:
            ...
            while cap.isOpened():
                ...
                # new, unmatched current groups to tracked_groups
                ...
                for tg_data in tracked_groups:
                    ...
                    text_bg_y1 = tg_data['centroid'][1] - 7 - text_h 
                    ...
                    if tg_data['consecutive_frames'] >= MIN_CONSECUTIVE_FRAMES_FOR_CROWD:
                        ...
                        print_interval = int(video_fps) if video_fps > 0 else 25 
